...
class attritionForm(forms.Form):
    Department= forms.ChoiceField(choices=[("All Department", "All Department"),("Sales", "Sales"),("Research & Development", "Research & Development"),("Human Resources","Human Resources")])
